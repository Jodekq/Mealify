...
<nav class="sm:container pt-6 flex justify-between mx-auto p-2">
	<div class="flex sm:flex-row flex-col">
		<a class="text-xl content-center text-accent-foreground font-bold" href="/">Mealify</a>
		<div class="text-[10px]">Early Access</div>
	</div>
	<div class="flex gap-2">
		<Button class="px-2 sm:px-4 font-bold flex gap-1" href="/saved_plates" variant="link"><i class='bx bx-save sm:text-sm text-xl'></i><div class="sm:block hidden">Saved Meals</div></Button>
		<Button class="px-2 sm:px-4 font-bold flex gap-1" href="/add_plate" variant="link"><i class='bx bxs-file-plus sm:text-sm text-xl'></i><div class="sm:block hidden">Add Meal</div></Button>
